  ...
  const menuItems = [
    {
      ...
      description: "Bekijk het overzicht",
    },
    {
      href: "/faq",
      icon: (
    ...
    },
    {
      ...
      label: "Hoe werkt het?",
      description: "Uitleg over Hulpwijzer",
    },
    {
      href: "/over-ons",
      icon: (
  ...
  return (
    <div className="min-h-screen pb-20 md:pb-0">
      <div className="px-4 py-6 max-w-3xl mx-auto">
        {/* Header */}
        <div className="mb-6">
          <h1 className="text-2xl font-bold mb-1">Meer</h1>
          <p className="text-sm text-[var(--muted-foreground)]">
            Extra opties en informatie
          </p>
        </div>
